...
//        public async Task<IActionResult> Create([Bind("StatusId,StatusName,Description")] ProductStatus productStatus)
//        {
//            if (productStatus is null)
//            {
//                throw new ArgumentNullException(nameof(productStatus));
//            }
...
//        [HttpPost]
//        [ValidateAntiForgeryToken]
//        public async Task<IActionResult> Edit(int id, [Bind("StatusId,StatusName,Description")] ProductStatus productStatus)
//        {
