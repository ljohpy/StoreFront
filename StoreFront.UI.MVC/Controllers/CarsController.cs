...
namespace StoreFront.UI.MVC.Controllers
{
    public class CarsController : Controller
    {
        ...
        public CarsController(StoreFrontContext context)
        {
            _context = context;
        }
        ...
        {
            var storeFrontContext = _context.Cars.Include(c => c.Status).Include(c => c.Style);
        ...
        public async Task<IActionResult> Create([Bind("CarId,Make,Model,Year,ExteriorColor,Miles,VinNumber,InteriorColor,Description,StatusId,StyleId")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarId,Make,Model,Year,ExteriorColor,Miles,VinNumber,InteriorColor,Description,StatusId,StyleId")] Car car)
        {
            if (id != car.CarId)
            {
                return NotFound();
