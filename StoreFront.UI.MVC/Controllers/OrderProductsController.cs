...
namespace StoreFront.UI.MVC.Controllers
{
    public class OrderProductsController : Controller
    {
        ...
        {
            var storeFrontContext = _context.OrderProducts.Include(o => o.Car).Include(o => o.Order);
        ...
        {
            ViewData["CarId"] = new SelectList(_context.Cars, "CarId", "ExteriorColor");
        ...
        public async Task<IActionResult> Create([Bind("OrderProductId,CarId,OrderId,Quanity,ProductPrice")] OrderProduct orderProduct)
        {
            ...
            ViewData["CarId"] = new SelectList(_context.Cars, "CarId", "ExteriorColor", orderProduct.CarId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderProductId,CarId,OrderId,Quanity,ProductPrice")] OrderProduct orderProduct)
        {
